              ...
              {({
                ...
                <form onSubmit={handleSubmit} className="space-y-2 pt-4">
                  ...
                  <button
                    ...
                    className="w-full mt-2 text-white text-md font-semibold py-3 rounded-lg cursor-pointer transition-all duration-300 disabled:opacity-75 disabled:cursor-not-allowed shadow-lg capitalize tracking-wide hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] bg-brand-gradient"
                  >
